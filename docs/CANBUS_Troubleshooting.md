...
micro-controller messages contained in a candump log. For example:
```
...
In the above example, `108` is the "canid". It is a hexadecimal
number. The id `108` is assigned by Klipper to the first
